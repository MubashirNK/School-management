  ...
  return (
    <div>
        ...
        <div className='bg-white mt-14 mb-10  p-8 rounded-lg shadow-2xl w-full md:w- max-w-md'>
            <h2 className='text-2xl font-bold mb-6 text-center'>Register Librarian</h2>
            ...
            <br /><br />
                ...
                <div className='mb-4'>
                    ...
                    <input type="text" placeholder='Mobile' value={formData.mobile} onChange={(event)=> {handleInputchange(event)}}
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-black sm:text-sm" />
                </div>
                <br /><br />
                <div className='mb-4'>
                    <label htmlFor="password" >Passsword : </label >
                    <input type="text" placeholder='Password' value={formData.password} onChange={(event)=> {handleInputchange(event)}} 
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-black sm:text-sm" 
